...
class WorkflowActivation(google.protobuf.message.Message):
    ...
    * Evictions also always come in their own activation
    ...
    def __init__(self, *, run_id: builtins.str = ..., timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ..., is_replaying: builtins.bool = ..., history_length: builtins.int = ..., jobs: collections.abc.Iterable[global___WorkflowActivationJob] | None = ..., available_internal_flags: collections.abc.Iterable[builtins.int] | None = ..., history_size_bytes: builtins.int = ..., continue_as_new_suggested: builtins.bool = ..., deployment_version_for_current_task: temporalio.bridge.proto.common.common_pb2.WorkerDeploymentVersion | None = ..., last_sdk_version: builtins.str = ...) -> None:
        ...
...
class FireTimer(google.protobuf.message.Message):
    ...
    seq: builtins.int
    def __init__(self, *, seq: builtins.int = ...) -> None:
        ...
...
class ResolveActivity(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., result: temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityResolution | None = ..., is_local: builtins.bool = ...) -> None:
        ...
...
class ResolveChildWorkflowExecutionStart(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., succeeded: global___ResolveChildWorkflowExecutionStartSuccess | None = ..., failed: global___ResolveChildWorkflowExecutionStartFailure | None = ..., cancelled: global___ResolveChildWorkflowExecutionStartCancelled | None = ...) -> None:
        ...
...
class ResolveChildWorkflowExecutionStartFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, workflow_id: builtins.str = ..., workflow_type: builtins.str = ..., cause: temporalio.bridge.proto.child_workflow.child_workflow_pb2.StartChildWorkflowExecutionFailedCause.ValueType = ...) -> None:
        ...
...
class ResolveChildWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., result: temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowResult | None = ...) -> None:
        ...
...
class UpdateRandomSeed(google.protobuf.message.Message):
    ...
    RANDOMNESS_SEED_FIELD_NUMBER: builtins.int
    randomness_seed: builtins.int
    def __init__(self, *, randomness_seed: builtins.int = ...) -> None:
        ...
...
class QueryWorkflow(google.protobuf.message.Message):
    ...
    def __init__(self, *, query_id: builtins.str = ..., query_type: builtins.str = ..., arguments: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ..., headers: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...) -> None:
        ...
...
class SignalWorkflow(google.protobuf.message.Message):
    ...
    def __init__(self, *, signal_name: builtins.str = ..., input: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ..., identity: builtins.str = ..., headers: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...) -> None:
        ...
...
class NotifyHasPatch(google.protobuf.message.Message):
    ...
    def __init__(self, *, patch_id: builtins.str = ...) -> None:
        ...
...
class ResolveSignalExternalWorkflow(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., failure: temporalio.api.failure.v1.message_pb2.Failure | None = ...) -> None:
        ...
...
class DoUpdate(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str = ..., protocol_instance_id: builtins.str = ..., name: builtins.str = ..., input: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ..., headers: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., meta: temporalio.api.update.v1.message_pb2.Meta | None = ..., run_validator: builtins.bool = ...) -> None:
        ...
...
class ResolveNexusOperationStart(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., operation_token: builtins.str = ..., started_sync: builtins.bool = ..., failed: temporalio.api.failure.v1.message_pb2.Failure | None = ...) -> None:
        ...
...
class ResolveNexusOperation(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., result: temporalio.bridge.proto.nexus.nexus_pb2.NexusOperationResult | None = ...) -> None:
        ...
...
class RemoveFromCache(google.protobuf.message.Message):
    ...
    class _EvictionReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RemoveFromCache._EvictionReason.ValueType], builtins.type):
        ...
        UNSPECIFIED: RemoveFromCache._EvictionReason.ValueType
        CACHE_FULL: RemoveFromCache._EvictionReason.ValueType
        CACHE_MISS: RemoveFromCache._EvictionReason.ValueType
        NONDETERMINISM: RemoveFromCache._EvictionReason.ValueType
        LANG_FAIL: RemoveFromCache._EvictionReason.ValueType
        LANG_REQUESTED: RemoveFromCache._EvictionReason.ValueType
        TASK_NOT_FOUND: RemoveFromCache._EvictionReason.ValueType
        UNHANDLED_COMMAND: RemoveFromCache._EvictionReason.ValueType
        FATAL: RemoveFromCache._EvictionReason.ValueType
        PAGINATION_OR_HISTORY_FETCH: RemoveFromCache._EvictionReason.ValueType
        WORKFLOW_EXECUTION_ENDING: RemoveFromCache._EvictionReason.ValueType
        ...
    ...
    UNSPECIFIED: RemoveFromCache.EvictionReason.ValueType
    CACHE_FULL: RemoveFromCache.EvictionReason.ValueType
    CACHE_MISS: RemoveFromCache.EvictionReason.ValueType
    NONDETERMINISM: RemoveFromCache.EvictionReason.ValueType
    LANG_FAIL: RemoveFromCache.EvictionReason.ValueType
    LANG_REQUESTED: RemoveFromCache.EvictionReason.ValueType
    TASK_NOT_FOUND: RemoveFromCache.EvictionReason.ValueType
    UNHANDLED_COMMAND: RemoveFromCache.EvictionReason.ValueType
    FATAL: RemoveFromCache.EvictionReason.ValueType
    PAGINATION_OR_HISTORY_FETCH: RemoveFromCache.EvictionReason.ValueType
    WORKFLOW_EXECUTION_ENDING: RemoveFromCache.EvictionReason.ValueType
    MESSAGE_FIELD_NUMBER: builtins.int
    REASON_FIELD_NUMBER: builtins.int
    message: builtins.str
    reason: global___RemoveFromCache.EvictionReason.ValueType
    def __init__(self, *, message: builtins.str = ..., reason: global___RemoveFromCache.EvictionReason.ValueType = ...) -> None:
        ...
