...
class _ActivityCancellationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityCancellationType.ValueType], builtins.type):
    ...
    TRY_CANCEL: _ActivityCancellationType.ValueType
    WAIT_CANCELLATION_COMPLETED: _ActivityCancellationType.ValueType
    ABANDON: _ActivityCancellationType.ValueType
    ...
...
TRY_CANCEL: ActivityCancellationType.ValueType
WAIT_CANCELLATION_COMPLETED: ActivityCancellationType.ValueType
ABANDON: ActivityCancellationType.ValueType
...
class StartTimer(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., start_to_fire_timeout: google.protobuf.duration_pb2.Duration | None = ...) -> None:
        ...
...
class ScheduleLocalActivity(google.protobuf.message.Message):
    ...
    cancellation_type: global___ActivityCancellationType.ValueType
    def __init__(self, *, seq: builtins.int = ..., activity_id: builtins.str = ..., activity_type: builtins.str = ..., attempt: builtins.int = ..., original_schedule_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., headers: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., arguments: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ..., schedule_to_close_timeout: google.protobuf.duration_pb2.Duration | None = ..., schedule_to_start_timeout: google.protobuf.duration_pb2.Duration | None = ..., start_to_close_timeout: google.protobuf.duration_pb2.Duration | None = ..., retry_policy: temporalio.api.common.v1.message_pb2.RetryPolicy | None = ..., local_retry_threshold: google.protobuf.duration_pb2.Duration | None = ..., cancellation_type: global___ActivityCancellationType.ValueType = ...) -> None:
        ...
...
class QueryResult(google.protobuf.message.Message):
    ...
    def __init__(self, *, query_id: builtins.str = ..., succeeded: global___QuerySuccess | None = ..., failed: temporalio.api.failure.v1.message_pb2.Failure | None = ...) -> None:
        ...
...
class QuerySuccess(google.protobuf.message.Message):
    ...
    def __init__(self, *, response: temporalio.api.common.v1.message_pb2.Payload | None = ...) -> None:
        ...
...
class SetPatchMarker(google.protobuf.message.Message):
    ...
    def __init__(self, *, patch_id: builtins.str = ..., deprecated: builtins.bool = ...) -> None:
        ...
...
class StartChildWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., namespace: builtins.str = ..., workflow_id: builtins.str = ..., workflow_type: builtins.str = ..., task_queue: builtins.str = ..., input: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ..., workflow_execution_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_run_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ..., parent_close_policy: temporalio.bridge.proto.child_workflow.child_workflow_pb2.ParentClosePolicy.ValueType = ..., workflow_id_reuse_policy: temporalio.api.enums.v1.workflow_pb2.WorkflowIdReusePolicy.ValueType = ..., retry_policy: temporalio.api.common.v1.message_pb2.RetryPolicy | None = ..., cron_schedule: builtins.str = ..., headers: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., memo: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., search_attributes: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., cancellation_type: temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowCancellationType.ValueType = ..., versioning_intent: temporalio.bridge.proto.common.common_pb2.VersioningIntent.ValueType = ..., priority: temporalio.api.common.v1.message_pb2.Priority | None = ...) -> None:
        ...
...
class CancelChildWorkflowExecution(google.protobuf.message.Message):
    ...
    reason: builtins.str
    def __init__(self, *, child_workflow_seq: builtins.int = ..., reason: builtins.str = ...) -> None:
        ...
...
class RequestCancelExternalWorkflowExecution(google.protobuf.message.Message):
    ...
    reason: builtins.str
    def __init__(self, *, seq: builtins.int = ..., workflow_execution: temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution | None = ..., reason: builtins.str = ...) -> None:
        ...
...
class UpsertWorkflowSearchAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, search_attributes: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...) -> None:
        ...
...
class ModifyWorkflowProperties(google.protobuf.message.Message):
    ...
    def __init__(self, *, upserted_memo: temporalio.api.common.v1.message_pb2.Memo | None = ...) -> None:
        ...
...
class UpdateResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, protocol_instance_id: builtins.str = ..., accepted: google.protobuf.empty_pb2.Empty | None = ..., rejected: temporalio.api.failure.v1.message_pb2.Failure | None = ..., completed: temporalio.api.common.v1.message_pb2.Payload | None = ...) -> None:
        ...
...
class ScheduleNexusOperation(google.protobuf.message.Message):
    ...
    def __init__(self, *, seq: builtins.int = ..., endpoint: builtins.str = ..., service: builtins.str = ..., operation: builtins.str = ..., input: temporalio.api.common.v1.message_pb2.Payload | None = ..., schedule_to_close_timeout: google.protobuf.duration_pb2.Duration | None = ..., nexus_header: collections.abc.Mapping[builtins.str, builtins.str] | None = ..., cancellation_type: temporalio.bridge.proto.nexus.nexus_pb2.NexusOperationCancellationType.ValueType = ...) -> None:
        ...
