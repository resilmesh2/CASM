...
class ActivityExecutionResult(google.protobuf.message.Message):
    ...
    def __init__(self, *, completed: global___Success | None = ..., failed: global___Failure | None = ..., cancelled: global___Cancellation | None = ..., will_complete_async: global___WillCompleteAsync | None = ...) -> None:
        ...
...
class ActivityResolution(google.protobuf.message.Message):
    ...
    def __init__(self, *, completed: global___Success | None = ..., failed: global___Failure | None = ..., cancelled: global___Cancellation | None = ..., backoff: global___DoBackoff | None = ...) -> None:
        ...
...
class DoBackoff(google.protobuf.message.Message):
    ...
    def __init__(self, *, attempt: builtins.int = ..., backoff_duration: google.protobuf.duration_pb2.Duration | None = ..., original_schedule_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
