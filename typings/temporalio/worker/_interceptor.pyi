...
from typing import Any, Awaitable, Generic, List, NoReturn, Optional, Sequence, Type, Union
...
class WorkflowOutboundInterceptor:
    ...
    async def start_nexus_operation(self, input: StartNexusOperationInput[InputT, OutputT]) -> temporalio.workflow.NexusOperationHandle[OutputT]:
