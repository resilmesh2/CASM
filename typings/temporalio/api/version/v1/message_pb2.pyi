...
class ReleaseInfo(google.protobuf.message.Message):
    ...
    notes: builtins.str
    def __init__(self, *, version: builtins.str = ..., release_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., notes: builtins.str = ...) -> None:
        ...
...
class Alert(google.protobuf.message.Message):
    ...
    def __init__(self, *, message: builtins.str = ..., severity: temporalio.api.enums.v1.common_pb2.Severity.ValueType = ...) -> None:
        ...
...
class VersionInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, current: global___ReleaseInfo | None = ..., recommended: global___ReleaseInfo | None = ..., instructions: builtins.str = ..., alerts: collections.abc.Iterable[global___Alert] | None = ..., last_update_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
