...
class EnhancedStackTrace(google.protobuf.message.Message):
    ...
    class SourcesEntry(google.protobuf.message.Message):
        ...
        def __init__(self, *, key: builtins.str = ..., value: global___StackTraceFileSlice | None = ...) -> None:
            ...
    ...
    def __init__(self, *, sdk: global___StackTraceSDKInfo | None = ..., sources: collections.abc.Mapping[builtins.str, global___StackTraceFileSlice] | None = ..., stacks: collections.abc.Iterable[global___StackTrace] | None = ...) -> None:
        ...
...
class StackTraceFileSlice(google.protobuf.message.Message):
    ...
    def __init__(self, *, line_offset: builtins.int = ..., content: builtins.str = ...) -> None:
        ...
...
class StackTraceFileLocation(google.protobuf.message.Message):
    ...
    def __init__(self, *, file_path: builtins.str = ..., line: builtins.int = ..., column: builtins.int = ..., function_name: builtins.str = ..., internal_code: builtins.bool = ...) -> None:
        ...
...
class StackTrace(google.protobuf.message.Message):
    ...
    def __init__(self, *, locations: collections.abc.Iterable[global___StackTraceFileLocation] | None = ...) -> None:
        ...
