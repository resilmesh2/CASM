...
class ApplicationFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, type: builtins.str = ..., non_retryable: builtins.bool = ..., details: temporalio.api.common.v1.message_pb2.Payloads | None = ..., next_retry_delay: google.protobuf.duration_pb2.Duration | None = ..., category: temporalio.api.enums.v1.common_pb2.ApplicationErrorCategory.ValueType = ...) -> None:
        ...
...
class TimeoutFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, timeout_type: temporalio.api.enums.v1.workflow_pb2.TimeoutType.ValueType = ..., last_heartbeat_details: temporalio.api.common.v1.message_pb2.Payloads | None = ...) -> None:
        ...
...
class ServerFailureInfo(google.protobuf.message.Message):
    ...
    NON_RETRYABLE_FIELD_NUMBER: builtins.int
    non_retryable: builtins.bool
    def __init__(self, *, non_retryable: builtins.bool = ...) -> None:
        ...
...
class ResetWorkflowFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, last_heartbeat_details: temporalio.api.common.v1.message_pb2.Payloads | None = ...) -> None:
        ...
...
class ActivityFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, scheduled_event_id: builtins.int = ..., started_event_id: builtins.int = ..., identity: builtins.str = ..., activity_type: temporalio.api.common.v1.message_pb2.ActivityType | None = ..., activity_id: builtins.str = ..., retry_state: temporalio.api.enums.v1.workflow_pb2.RetryState.ValueType = ...) -> None:
        ...
...
class ChildWorkflowExecutionFailureInfo(google.protobuf.message.Message):
    ...
    started_event_id: builtins.int
    retry_state: temporalio.api.enums.v1.workflow_pb2.RetryState.ValueType
    def __init__(self, *, namespace: builtins.str = ..., workflow_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., workflow_type: temporalio.api.common.v1.message_pb2.WorkflowType | None = ..., initiated_event_id: builtins.int = ..., started_event_id: builtins.int = ..., retry_state: temporalio.api.enums.v1.workflow_pb2.RetryState.ValueType = ...) -> None:
        ...
...
class NexusOperationFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, scheduled_event_id: builtins.int = ..., endpoint: builtins.str = ..., service: builtins.str = ..., operation: builtins.str = ..., operation_id: builtins.str = ..., operation_token: builtins.str = ...) -> None:
        ...
...
class NexusHandlerFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, type: builtins.str = ..., retry_behavior: temporalio.api.enums.v1.nexus_pb2.NexusHandlerErrorRetryBehavior.ValueType = ...) -> None:
        ...
...
class Failure(google.protobuf.message.Message):
    ...
    def __init__(self, *, message: builtins.str = ..., source: builtins.str = ..., stack_trace: builtins.str = ..., encoded_attributes: temporalio.api.common.v1.message_pb2.Payload | None = ..., cause: global___Failure | None = ..., application_failure_info: global___ApplicationFailureInfo | None = ..., timeout_failure_info: global___TimeoutFailureInfo | None = ..., canceled_failure_info: global___CanceledFailureInfo | None = ..., terminated_failure_info: global___TerminatedFailureInfo | None = ..., server_failure_info: global___ServerFailureInfo | None = ..., reset_workflow_failure_info: global___ResetWorkflowFailureInfo | None = ..., activity_failure_info: global___ActivityFailureInfo | None = ..., child_workflow_execution_failure_info: global___ChildWorkflowExecutionFailureInfo | None = ..., nexus_operation_execution_failure_info: global___NexusOperationFailureInfo | None = ..., nexus_handler_failure_info: global___NexusHandlerFailureInfo | None = ...) -> None:
        ...
