...
class RequestCancelActivityTaskCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, scheduled_event_id: builtins.int = ...) -> None:
        ...
...
class StartTimerCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, timer_id: builtins.str = ..., start_to_fire_timeout: google.protobuf.duration_pb2.Duration | None = ...) -> None:
        ...
...
class CompleteWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, result: temporalio.api.common.v1.message_pb2.Payloads | None = ...) -> None:
        ...
...
class CancelTimerCommandAttributes(google.protobuf.message.Message):
    ...
    TIMER_ID_FIELD_NUMBER: builtins.int
    timer_id: builtins.str
    def __init__(self, *, timer_id: builtins.str = ...) -> None:
        ...
...
class CancelWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, details: temporalio.api.common.v1.message_pb2.Payloads | None = ...) -> None:
        ...
...
class RequestCancelExternalWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    reason: builtins.str
    def __init__(self, *, namespace: builtins.str = ..., workflow_id: builtins.str = ..., run_id: builtins.str = ..., control: builtins.str = ..., child_workflow_only: builtins.bool = ..., reason: builtins.str = ...) -> None:
        ...
...
class SignalExternalWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, namespace: builtins.str = ..., execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., signal_name: builtins.str = ..., input: temporalio.api.common.v1.message_pb2.Payloads | None = ..., control: builtins.str = ..., child_workflow_only: builtins.bool = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ...) -> None:
        ...
...
class UpsertWorkflowSearchAttributesCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, search_attributes: temporalio.api.common.v1.message_pb2.SearchAttributes | None = ...) -> None:
        ...
...
class RecordMarkerCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, marker_name: builtins.str = ..., details: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payloads] | None = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ..., failure: temporalio.api.failure.v1.message_pb2.Failure | None = ...) -> None:
        ...
...
class ContinueAsNewWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, workflow_type: temporalio.api.common.v1.message_pb2.WorkflowType | None = ..., task_queue: temporalio.api.taskqueue.v1.message_pb2.TaskQueue | None = ..., input: temporalio.api.common.v1.message_pb2.Payloads | None = ..., workflow_run_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ..., backoff_start_interval: google.protobuf.duration_pb2.Duration | None = ..., retry_policy: temporalio.api.common.v1.message_pb2.RetryPolicy | None = ..., initiator: temporalio.api.enums.v1.workflow_pb2.ContinueAsNewInitiator.ValueType = ..., failure: temporalio.api.failure.v1.message_pb2.Failure | None = ..., last_completion_result: temporalio.api.common.v1.message_pb2.Payloads | None = ..., cron_schedule: builtins.str = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ..., memo: temporalio.api.common.v1.message_pb2.Memo | None = ..., search_attributes: temporalio.api.common.v1.message_pb2.SearchAttributes | None = ..., inherit_build_id: builtins.bool = ...) -> None:
        ...
...
class StartChildWorkflowExecutionCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, namespace: builtins.str = ..., workflow_id: builtins.str = ..., workflow_type: temporalio.api.common.v1.message_pb2.WorkflowType | None = ..., task_queue: temporalio.api.taskqueue.v1.message_pb2.TaskQueue | None = ..., input: temporalio.api.common.v1.message_pb2.Payloads | None = ..., workflow_execution_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_run_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ..., parent_close_policy: temporalio.api.enums.v1.workflow_pb2.ParentClosePolicy.ValueType = ..., control: builtins.str = ..., workflow_id_reuse_policy: temporalio.api.enums.v1.workflow_pb2.WorkflowIdReusePolicy.ValueType = ..., retry_policy: temporalio.api.common.v1.message_pb2.RetryPolicy | None = ..., cron_schedule: builtins.str = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ..., memo: temporalio.api.common.v1.message_pb2.Memo | None = ..., search_attributes: temporalio.api.common.v1.message_pb2.SearchAttributes | None = ..., inherit_build_id: builtins.bool = ..., priority: temporalio.api.common.v1.message_pb2.Priority | None = ...) -> None:
        ...
...
class ProtocolMessageCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, message_id: builtins.str = ...) -> None:
        ...
...
class ScheduleNexusOperationCommandAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, endpoint: builtins.str = ..., service: builtins.str = ..., operation: builtins.str = ..., input: temporalio.api.common.v1.message_pb2.Payload | None = ..., schedule_to_close_timeout: google.protobuf.duration_pb2.Duration | None = ..., nexus_header: collections.abc.Mapping[builtins.str, builtins.str] | None = ...) -> None:
        ...
