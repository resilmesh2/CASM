...
class WorkflowQuery(google.protobuf.message.Message):
    ...
    def __init__(self, *, query_type: builtins.str = ..., query_args: temporalio.api.common.v1.message_pb2.Payloads | None = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ...) -> None:
        ...
...
class WorkflowQueryResult(google.protobuf.message.Message):
    ...
    def __init__(self, *, result_type: temporalio.api.enums.v1.query_pb2.QueryResultType.ValueType = ..., answer: temporalio.api.common.v1.message_pb2.Payloads | None = ..., error_message: builtins.str = ..., failure: temporalio.api.failure.v1.message_pb2.Failure | None = ...) -> None:
        ...
...
class QueryRejected(google.protobuf.message.Message):
    ...
    def __init__(self, *, status: temporalio.api.enums.v1.workflow_pb2.WorkflowExecutionStatus.ValueType = ...) -> None:
        ...
