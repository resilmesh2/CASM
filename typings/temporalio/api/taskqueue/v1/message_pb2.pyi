...
class TaskQueue(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: builtins.str = ..., kind: temporalio.api.enums.v1.task_queue_pb2.TaskQueueKind.ValueType = ..., normal_name: builtins.str = ...) -> None:
        ...
...
class TaskQueueMetadata(google.protobuf.message.Message):
    ...
    def __init__(self, *, max_tasks_per_second: google.protobuf.wrappers_pb2.DoubleValue | None = ...) -> None:
        ...
...
class TaskQueueVersioningInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, current_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ..., current_version: builtins.str = ..., ramping_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ..., ramping_version: builtins.str = ..., ramping_version_percentage: builtins.float = ..., update_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
...
class TaskQueueVersionSelection(google.protobuf.message.Message):
    ...
    def __init__(self, *, build_ids: collections.abc.Iterable[builtins.str] | None = ..., unversioned: builtins.bool = ..., all_active: builtins.bool = ...) -> None:
        ...
...
class TaskQueueVersionInfo(google.protobuf.message.Message):
    ...
    class TypesInfoEntry(google.protobuf.message.Message):
        ...
        def __init__(self, *, key: builtins.int = ..., value: global___TaskQueueTypeInfo | None = ...) -> None:
            ...
    ...
    def __init__(self, *, types_info: collections.abc.Mapping[builtins.int, global___TaskQueueTypeInfo] | None = ..., task_reachability: temporalio.api.enums.v1.task_queue_pb2.BuildIdTaskReachability.ValueType = ...) -> None:
        ...
...
class TaskQueueTypeInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, pollers: collections.abc.Iterable[global___PollerInfo] | None = ..., stats: global___TaskQueueStats | None = ...) -> None:
        ...
...
class TaskQueueStats(google.protobuf.message.Message):
    ...
    def __init__(self, *, approximate_backlog_count: builtins.int = ..., approximate_backlog_age: google.protobuf.duration_pb2.Duration | None = ..., tasks_add_rate: builtins.float = ..., tasks_dispatch_rate: builtins.float = ...) -> None:
        ...
...
class TaskQueueStatus(google.protobuf.message.Message):
    ...
    def __init__(self, *, backlog_count_hint: builtins.int = ..., read_level: builtins.int = ..., ack_level: builtins.int = ..., rate_per_second: builtins.float = ..., task_id_block: global___TaskIdBlock | None = ...) -> None:
        ...
...
class TaskIdBlock(google.protobuf.message.Message):
    ...
    end_id: builtins.int
    def __init__(self, *, start_id: builtins.int = ..., end_id: builtins.int = ...) -> None:
        ...
...
class TaskQueuePartitionMetadata(google.protobuf.message.Message):
    ...
    def __init__(self, *, key: builtins.str = ..., owner_host_name: builtins.str = ...) -> None:
        ...
...
class StickyExecutionAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, worker_task_queue: global___TaskQueue | None = ..., schedule_to_start_timeout: google.protobuf.duration_pb2.Duration | None = ...) -> None:
        ...
...
class CompatibleVersionSet(google.protobuf.message.Message):
    ...
    def __init__(self, *, build_ids: collections.abc.Iterable[builtins.str] | None = ...) -> None:
        ...
...
class TaskQueueReachability(google.protobuf.message.Message):
    ...
    def __init__(self, *, task_queue: builtins.str = ..., reachability: collections.abc.Iterable[temporalio.api.enums.v1.task_queue_pb2.TaskReachability.ValueType] | None = ...) -> None:
        ...
...
class BuildIdReachability(google.protobuf.message.Message):
    ...
    def __init__(self, *, build_id: builtins.str = ..., task_queue_reachability: collections.abc.Iterable[global___TaskQueueReachability] | None = ...) -> None:
        ...
...
class RampByPercentage(google.protobuf.message.Message):
    ...
    def __init__(self, *, ramp_percentage: builtins.float = ...) -> None:
        ...
...
class BuildIdAssignmentRule(google.protobuf.message.Message):
    ...
    def __init__(self, *, target_build_id: builtins.str = ..., percentage_ramp: global___RampByPercentage | None = ...) -> None:
        ...
...
class CompatibleBuildIdRedirectRule(google.protobuf.message.Message):
    ...
    target_build_id: builtins.str
    def __init__(self, *, source_build_id: builtins.str = ..., target_build_id: builtins.str = ...) -> None:
        ...
...
class TimestampedBuildIdAssignmentRule(google.protobuf.message.Message):
    ...
    def __init__(self, *, rule: global___BuildIdAssignmentRule | None = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
...
class TimestampedCompatibleBuildIdRedirectRule(google.protobuf.message.Message):
    ...
    def __init__(self, *, rule: global___CompatibleBuildIdRedirectRule | None = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
...
class PollerScalingDecision(google.protobuf.message.Message):
    ...
    def __init__(self, *, poll_request_delta_suggestion: builtins.int = ...) -> None:
        ...
...
class RateLimit(google.protobuf.message.Message):
    ...
    def __init__(self, *, requests_per_second: builtins.float = ...) -> None:
        ...
...
class ConfigMetadata(google.protobuf.message.Message):
    ...
    def __init__(self, *, reason: builtins.str = ..., update_identity: builtins.str = ..., update_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
...
class RateLimitConfig(google.protobuf.message.Message):
    ...
    def __init__(self, *, rate_limit: global___RateLimit | None = ..., metadata: global___ConfigMetadata | None = ...) -> None:
        ...
...
class TaskQueueConfig(google.protobuf.message.Message):
    ...
    def __init__(self, *, queue_rate_limit: global___RateLimitConfig | None = ..., fairness_keys_rate_limit_default: global___RateLimitConfig | None = ...) -> None:
        ...
