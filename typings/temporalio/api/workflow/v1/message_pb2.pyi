...
class WorkflowExecutionInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., type: temporalio.api.common.v1.message_pb2.WorkflowType | None = ..., start_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., close_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., status: temporalio.api.enums.v1.workflow_pb2.WorkflowExecutionStatus.ValueType = ..., history_length: builtins.int = ..., parent_namespace_id: builtins.str = ..., parent_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., execution_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., memo: temporalio.api.common.v1.message_pb2.Memo | None = ..., search_attributes: temporalio.api.common.v1.message_pb2.SearchAttributes | None = ..., auto_reset_points: global___ResetPoints | None = ..., task_queue: builtins.str = ..., state_transition_count: builtins.int = ..., history_size_bytes: builtins.int = ..., most_recent_worker_version_stamp: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ..., execution_duration: google.protobuf.duration_pb2.Duration | None = ..., root_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., assigned_build_id: builtins.str = ..., inherited_build_id: builtins.str = ..., first_run_id: builtins.str = ..., versioning_info: global___WorkflowExecutionVersioningInfo | None = ..., worker_deployment_name: builtins.str = ..., priority: temporalio.api.common.v1.message_pb2.Priority | None = ...) -> None:
        ...
...
class WorkflowExecutionExtendedInfo(google.protobuf.message.Message):
    ...
    class RequestIdInfosEntry(google.protobuf.message.Message):
        ...
        def __init__(self, *, key: builtins.str = ..., value: global___RequestIdInfo | None = ...) -> None:
            ...
...
class WorkflowExecutionVersioningInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, behavior: temporalio.api.enums.v1.workflow_pb2.VersioningBehavior.ValueType = ..., deployment: temporalio.api.deployment.v1.message_pb2.Deployment | None = ..., version: builtins.str = ..., deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ..., versioning_override: global___VersioningOverride | None = ..., deployment_transition: global___DeploymentTransition | None = ..., version_transition: global___DeploymentVersionTransition | None = ...) -> None:
        ...
...
class DeploymentTransition(google.protobuf.message.Message):
    ...
    def __init__(self, *, deployment: temporalio.api.deployment.v1.message_pb2.Deployment | None = ...) -> None:
        ...
...
class DeploymentVersionTransition(google.protobuf.message.Message):
    ...
    def __init__(self, *, version: builtins.str = ..., deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...) -> None:
        ...
...
class WorkflowExecutionConfig(google.protobuf.message.Message):
    ...
    def __init__(self, *, task_queue: temporalio.api.taskqueue.v1.message_pb2.TaskQueue | None = ..., workflow_execution_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_run_timeout: google.protobuf.duration_pb2.Duration | None = ..., default_workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ..., user_metadata: temporalio.api.sdk.v1.user_metadata_pb2.UserMetadata | None = ...) -> None:
        ...
...
class PendingActivityInfo(google.protobuf.message.Message):
    ...
    class PauseInfo(google.protobuf.message.Message):
        ...
        class Manual(google.protobuf.message.Message):
            ...
            reason: builtins.str
            def __init__(self, *, identity: builtins.str = ..., reason: builtins.str = ...) -> None:
                ...
        ...
        class Rule(google.protobuf.message.Message):
            ...
            identity: builtins.str
            reason: builtins.str
            def __init__(self, *, rule_id: builtins.str = ..., identity: builtins.str = ..., reason: builtins.str = ...) -> None:
                ...
        ...
        def __init__(self, *, pause_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., manual: global___PendingActivityInfo.PauseInfo.Manual | None = ..., rule: global___PendingActivityInfo.PauseInfo.Rule | None = ...) -> None:
            ...
    ...
    def __init__(self, *, activity_id: builtins.str = ..., activity_type: temporalio.api.common.v1.message_pb2.ActivityType | None = ..., state: temporalio.api.enums.v1.workflow_pb2.PendingActivityState.ValueType = ..., heartbeat_details: temporalio.api.common.v1.message_pb2.Payloads | None = ..., last_heartbeat_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., last_started_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., attempt: builtins.int = ..., maximum_attempts: builtins.int = ..., scheduled_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., expiration_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., last_failure: temporalio.api.failure.v1.message_pb2.Failure | None = ..., last_worker_identity: builtins.str = ..., use_workflow_build_id: google.protobuf.empty_pb2.Empty | None = ..., last_independently_assigned_build_id: builtins.str = ..., last_worker_version_stamp: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ..., current_retry_interval: google.protobuf.duration_pb2.Duration | None = ..., last_attempt_complete_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., next_attempt_schedule_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., paused: builtins.bool = ..., last_deployment: temporalio.api.deployment.v1.message_pb2.Deployment | None = ..., last_worker_deployment_version: builtins.str = ..., last_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ..., priority: temporalio.api.common.v1.message_pb2.Priority | None = ..., pause_info: global___PendingActivityInfo.PauseInfo | None = ..., activity_options: temporalio.api.activity.v1.message_pb2.ActivityOptions | None = ...) -> None:
        ...
...
class PendingChildExecutionInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, workflow_id: builtins.str = ..., run_id: builtins.str = ..., workflow_type_name: builtins.str = ..., initiated_id: builtins.int = ..., parent_close_policy: temporalio.api.enums.v1.workflow_pb2.ParentClosePolicy.ValueType = ...) -> None:
        ...
...
class PendingWorkflowTaskInfo(google.protobuf.message.Message):
    ...
    attempt: builtins.int
    def __init__(self, *, state: temporalio.api.enums.v1.workflow_pb2.PendingWorkflowTaskState.ValueType = ..., scheduled_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., original_scheduled_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., started_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., attempt: builtins.int = ...) -> None:
        ...
...
class ResetPoints(google.protobuf.message.Message):
    ...
    def __init__(self, *, points: collections.abc.Iterable[global___ResetPointInfo] | None = ...) -> None:
        ...
...
class ResetPointInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, build_id: builtins.str = ..., binary_checksum: builtins.str = ..., run_id: builtins.str = ..., first_workflow_task_completed_id: builtins.int = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., expire_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., resettable: builtins.bool = ...) -> None:
        ...
...
class NewWorkflowExecutionInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, workflow_id: builtins.str = ..., workflow_type: temporalio.api.common.v1.message_pb2.WorkflowType | None = ..., task_queue: temporalio.api.taskqueue.v1.message_pb2.TaskQueue | None = ..., input: temporalio.api.common.v1.message_pb2.Payloads | None = ..., workflow_execution_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_run_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ..., workflow_id_reuse_policy: temporalio.api.enums.v1.workflow_pb2.WorkflowIdReusePolicy.ValueType = ..., retry_policy: temporalio.api.common.v1.message_pb2.RetryPolicy | None = ..., cron_schedule: builtins.str = ..., memo: temporalio.api.common.v1.message_pb2.Memo | None = ..., search_attributes: temporalio.api.common.v1.message_pb2.SearchAttributes | None = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ..., user_metadata: temporalio.api.sdk.v1.user_metadata_pb2.UserMetadata | None = ..., versioning_override: global___VersioningOverride | None = ..., priority: temporalio.api.common.v1.message_pb2.Priority | None = ...) -> None:
        ...
...
class CallbackInfo(google.protobuf.message.Message):
    ...
    class Trigger(google.protobuf.message.Message):
        ...
        def __init__(self, *, workflow_closed: global___CallbackInfo.WorkflowClosed | None = ...) -> None:
            ...
...
class WorkflowExecutionOptions(google.protobuf.message.Message):
    ...
    def __init__(self, *, versioning_override: global___VersioningOverride | None = ...) -> None:
        ...
...
class VersioningOverride(google.protobuf.message.Message):
    ...
    class _PinnedOverrideBehaviorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[VersioningOverride._PinnedOverrideBehavior.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PINNED_OVERRIDE_BEHAVIOR_UNSPECIFIED: VersioningOverride._PinnedOverrideBehavior.ValueType
        PINNED_OVERRIDE_BEHAVIOR_PINNED: VersioningOverride._PinnedOverrideBehavior.ValueType
        ...
    ...
    PINNED_OVERRIDE_BEHAVIOR_UNSPECIFIED: VersioningOverride.PinnedOverrideBehavior.ValueType
    PINNED_OVERRIDE_BEHAVIOR_PINNED: VersioningOverride.PinnedOverrideBehavior.ValueType
    class PinnedOverride(google.protobuf.message.Message):
        ...
        def __init__(self, *, behavior: global___VersioningOverride.PinnedOverrideBehavior.ValueType = ..., version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...) -> None:
            ...
    ...
    def __init__(self, *, pinned: global___VersioningOverride.PinnedOverride | None = ..., auto_upgrade: builtins.bool = ..., behavior: temporalio.api.enums.v1.workflow_pb2.VersioningBehavior.ValueType = ..., deployment: temporalio.api.deployment.v1.message_pb2.Deployment | None = ..., pinned_version: builtins.str = ...) -> None:
        ...
...
class OnConflictOptions(google.protobuf.message.Message):
    ...
    def __init__(self, *, attach_request_id: builtins.bool = ..., attach_completion_callbacks: builtins.bool = ..., attach_links: builtins.bool = ...) -> None:
        ...
...
class RequestIdInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, event_type: temporalio.api.enums.v1.event_type_pb2.EventType.ValueType = ..., event_id: builtins.int = ..., buffered: builtins.bool = ...) -> None:
        ...
...
class PostResetOperation(google.protobuf.message.Message):
    ...
    class SignalWorkflow(google.protobuf.message.Message):
        ...
        def __init__(self, *, signal_name: builtins.str = ..., input: temporalio.api.common.v1.message_pb2.Payloads | None = ..., header: temporalio.api.common.v1.message_pb2.Header | None = ..., links: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Link] | None = ...) -> None:
            ...
    ...
    class UpdateWorkflowOptions(google.protobuf.message.Message):
        ...
        def __init__(self, *, workflow_execution_options: global___WorkflowExecutionOptions | None = ..., update_mask: google.protobuf.field_mask_pb2.FieldMask | None = ...) -> None:
            ...
    ...
    def __init__(self, *, signal_workflow: global___PostResetOperation.SignalWorkflow | None = ..., update_workflow_options: global___PostResetOperation.UpdateWorkflowOptions | None = ...) -> None:
        ...
