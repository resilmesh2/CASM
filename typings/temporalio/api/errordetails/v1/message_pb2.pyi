...
class NotFoundFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, current_cluster: builtins.str = ..., active_cluster: builtins.str = ...) -> None:
        ...
...
class WorkflowExecutionAlreadyStartedFailure(google.protobuf.message.Message):
    ...
    run_id: builtins.str
    def __init__(self, *, start_request_id: builtins.str = ..., run_id: builtins.str = ...) -> None:
        ...
...
class NamespaceNotActiveFailure(google.protobuf.message.Message):
    ...
    current_cluster: builtins.str
    active_cluster: builtins.str
    def __init__(self, *, namespace: builtins.str = ..., current_cluster: builtins.str = ..., active_cluster: builtins.str = ...) -> None:
        ...
...
class NamespaceInvalidStateFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, namespace: builtins.str = ..., state: temporalio.api.enums.v1.namespace_pb2.NamespaceState.ValueType = ..., allowed_states: collections.abc.Iterable[temporalio.api.enums.v1.namespace_pb2.NamespaceState.ValueType] | None = ...) -> None:
        ...
...
class ClientVersionNotSupportedFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, client_version: builtins.str = ..., client_name: builtins.str = ..., supported_versions: builtins.str = ...) -> None:
        ...
...
class ServerVersionNotSupportedFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, server_version: builtins.str = ..., client_supported_server_versions: builtins.str = ...) -> None:
        ...
...
class ResourceExhaustedFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, cause: temporalio.api.enums.v1.failed_cause_pb2.ResourceExhaustedCause.ValueType = ..., scope: temporalio.api.enums.v1.failed_cause_pb2.ResourceExhaustedScope.ValueType = ...) -> None:
        ...
...
class SystemWorkflowFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, workflow_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ..., workflow_error: builtins.str = ...) -> None:
        ...
...
class NewerBuildExistsFailure(google.protobuf.message.Message):
    ...
    def __init__(self, *, default_build_id: builtins.str = ...) -> None:
        ...
...
class MultiOperationExecutionFailure(google.protobuf.message.Message):
    ...
    class OperationStatus(google.protobuf.message.Message):
        ...
        def __init__(self, *, code: builtins.int = ..., message: builtins.str = ..., details: collections.abc.Iterable[google.protobuf.any_pb2.Any] | None = ...) -> None:
            ...
    ...
    def __init__(self, *, statuses: collections.abc.Iterable[global___MultiOperationExecutionFailure.OperationStatus] | None = ...) -> None:
        ...
