...
class WorkerDeploymentOptions(google.protobuf.message.Message):
    ...
    def __init__(self, *, deployment_name: builtins.str = ..., build_id: builtins.str = ..., worker_versioning_mode: temporalio.api.enums.v1.deployment_pb2.WorkerVersioningMode.ValueType = ...) -> None:
        ...
...
class Deployment(google.protobuf.message.Message):
    ...
    build_id: builtins.str
    def __init__(self, *, series_name: builtins.str = ..., build_id: builtins.str = ...) -> None:
        ...
...
class DeploymentInfo(google.protobuf.message.Message):
    ...
    class TaskQueueInfo(google.protobuf.message.Message):
        ...
        def __init__(self, *, name: builtins.str = ..., type: temporalio.api.enums.v1.task_queue_pb2.TaskQueueType.ValueType = ..., first_poller_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
            ...
    ...
    def __init__(self, *, deployment: global___Deployment | None = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., task_queue_infos: collections.abc.Iterable[global___DeploymentInfo.TaskQueueInfo] | None = ..., metadata: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., is_current: builtins.bool = ...) -> None:
        ...
...
class UpdateDeploymentMetadata(google.protobuf.message.Message):
    ...
    def __init__(self, *, upsert_entries: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ..., remove_entries: collections.abc.Iterable[builtins.str] | None = ...) -> None:
        ...
...
class DeploymentListInfo(google.protobuf.message.Message):
    ...
    is_current: builtins.bool
    def __init__(self, *, deployment: global___Deployment | None = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., is_current: builtins.bool = ...) -> None:
        ...
...
class WorkerDeploymentVersionInfo(google.protobuf.message.Message):
    ...
    class VersionTaskQueueInfo(google.protobuf.message.Message):
        ...
        name: builtins.str
        type: temporalio.api.enums.v1.task_queue_pb2.TaskQueueType.ValueType
        def __init__(self, *, name: builtins.str = ..., type: temporalio.api.enums.v1.task_queue_pb2.TaskQueueType.ValueType = ...) -> None:
            ...
...
class VersionDrainageInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, status: temporalio.api.enums.v1.deployment_pb2.VersionDrainageStatus.ValueType = ..., last_changed_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., last_checked_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
        ...
...
class WorkerDeploymentInfo(google.protobuf.message.Message):
    ...
    class WorkerDeploymentVersionSummary(google.protobuf.message.Message):
        ...
        def __init__(self, *, version: builtins.str = ..., status: temporalio.api.enums.v1.deployment_pb2.WorkerDeploymentVersionStatus.ValueType = ..., deployment_version: global___WorkerDeploymentVersion | None = ..., create_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., drainage_status: temporalio.api.enums.v1.deployment_pb2.VersionDrainageStatus.ValueType = ..., drainage_info: global___VersionDrainageInfo | None = ..., current_since_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., ramping_since_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., routing_update_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., first_activation_time: google.protobuf.timestamp_pb2.Timestamp | None = ..., last_deactivation_time: google.protobuf.timestamp_pb2.Timestamp | None = ...) -> None:
            ...
...
class WorkerDeploymentVersion(google.protobuf.message.Message):
    ...
    build_id: builtins.str
    deployment_name: builtins.str
    def __init__(self, *, build_id: builtins.str = ..., deployment_name: builtins.str = ...) -> None:
        ...
...
class VersionMetadata(google.protobuf.message.Message):
    ...
    def __init__(self, *, entries: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...) -> None:
        ...
